          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h1 className="text-4xl md:text-6xl font-bold font-heading mb-6">
                Welcome to <span className="text-yellow-400">E-Store</span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-primary-100">
                Discover amazing products at unbeatable prices. Shop with
                confidence and enjoy fast, free shipping.
              </p>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-md">
                ...
                <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 text-center">
                  <svg
                    className="w-32 h-32 mx-auto mb-4 text-yellow-400"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover our handpicked selection of trending products at amazing
              prices
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <Button onClick={loadFeaturedProducts}>Try Again</Button>
            </div>
